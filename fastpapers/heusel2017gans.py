...
__all__ = ['Inception', 'get_cudas', 'PrintCudaDiff', 'FIDMetric', 'print_diff_cudas']
...
class PrintCudaDiff:
    ...
    def __call__(self, event):
        new_cudas = get_cudas()
        diff_cudas = new_cudas - self.n
        print(f'event: {event}, old {self.n}, new {new_cudas}, diff {diff_cudas}')
        self.n = new_cudas
print_diff_cudas = PrintCudaDiff()
